...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class ComposeLibraryAccessors extends SubDependencyFactory {
        ...
        public ComposeLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getActivityCompose() { return create("compose.activityCompose"); }

            /**
             * Creates a dependency provider for foundationLayout (androidx.compose.foundation:foundation-layout)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getFoundationLayout() { return create("compose.foundationLayout"); }
    ...
    public static class GradlePluginLibraryAccessors extends SubDependencyFactory {
        ...
        public GradlePluginLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
             ...
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getBuildtools() { return create("gradle.plugin.buildtools"); }

            /**
             * Creates a dependency provider for kotlin (org.jetbrains.kotlin:kotlin-gradle-plugin)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getKotlin() { return create("gradle.plugin.kotlin"); }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: gradleBuildTools (7.0.4)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getGradleBuildTools() { return getVersion("gradleBuildTools"); }

            /**
             * Returns the version associated to this alias: gradleVersionPlugin (0.39.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getGradleVersionPlugin() { return getVersion("gradleVersionPlugin"); }

            /**
             * Returns the version associated to this alias: jetpackCompose (1.1.0-rc01)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getJetpackCompose() { return getVersion("jetpackCompose"); }
            ...
            /**
             * Returns the version associated to this alias: targetSdk (29)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class BundleAccessors extends BundleFactory {
        ...
        public BundleAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Creates a dependency bundle provider for composeAll which is an aggregate for the following dependencies:
             * <ul>
             ...
             */
            public Provider<ExternalModuleDependencyBundle> getComposeAll() { return createBundle("composeAll"); }
