...
@NonNullApi
public class Pano360ProjectDependency extends DelegatingProjectDependency {

    @Inject
    public Pano360ProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
